...
import { CaptureFinger, VerifyFinger } from "./../../../features/scanner";
import React from "react";
import { ToastContainer, toast } from "react-toastify";
import "react-toastify/dist/ReactToastify.css";
import { useGlobalContext } from "./../../GlobalContext.jsx";
import { toastOptions } from "../../../constants/toastConfig.jsx";
...
function AdminRegister() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setMessage("User fingerprint registration done successfully!", {...toastOptions});
      } else {
  ...
  const handleFingerprintCapture = async () => {
    ...
    try {
      ...
      toast.success("Fingerprint captureed successfully!", {...toastOptions});
  ...
  return (
    <div className="w-full min-h-screen bg-gray-100 flex items-center justify-center">
      {/* <ToastContainer /> */}
      <div className="bg-white p-8 rounded-xl shadow-[0_0px_8px_rgba(0,233,154)] w-full max-w-md mx-auto m-2">
        <p className="text-xl sm:text-2xl font-bold text-center text-gray-800 mb-6">
          Register Students FingerPrint
        </p>
        <form className="space-y-6 font-bold" onSubmit={handleSubmit}>
          ...
          <div className="space-y-2">
            ...
            <button
              ...
              className="w-full bg-[#3883eb] p-2 bg-blue-500 text-white rounded-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
              Capture Fingerprint
            </button>
          ...
          <button
            type="submit"
            className="w-full p-2 text-white rounded-md bg-[#00df9a] focus:outline-none focus:ring-2 focus:ring-green-500"
          >
            Add Fingerprint
          </button>
        </form>
